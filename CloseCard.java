...
class CloseCard implements ActionListener {
	Container myPanel;
	JTextArea ta;
	int patientCount = 0;
    CardCatalog catalog;
	...
	CloseCard (Container panel, CardCatalog catalog) {
		this.myPanel = panel;
	...
	public void initButton() {		
		JLabel label = new JLabel("Card closing");
		JButton send = new JButton("CloseCard");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(params.contains("CloseCard")) {
			System.out.println("Card is closed for " + selectedBook);
		}
    }
}